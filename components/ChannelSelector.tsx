...
// Extended to include Facebook (UI-only for now)
export type ExtendedChannel = Channel | 'facebook';
...
interface ChannelSelectorProps {
  selected: ExtendedChannel[];
  onChange: (channels: ExtendedChannel[]) => void;
  disabled?: boolean;
}
  ...
  return (
    <div className="grid grid-cols-2 gap-2">
      {CHANNEL_CONFIGS.map((cfg) => {
        const isSelected = selected.includes(cfg.id);
            ...
            <div className="flex items-center justify-between w-full">
              ...
              <div
                ...
                style={{
                  ...
                  border: `2px solid ${isSelected ? cfg.color : 'var(--border-mid)'}`,
                }}
              >
                {isSelected && (
              ...
              {/* Platform icon */}
              <span style={{ color: isSelected ? cfg.color : 'var(--text-muted)' }}>
                {cfg.icon}
              </span>
            </div>
